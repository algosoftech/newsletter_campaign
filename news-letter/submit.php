...
$created_date = $date;
 $query = "INSERT INTO pt_users(name, email, mobile, city, campaign_name, created_date) VALUES('$name', '$email', '$mobile', '$city','healthzine_newsletter_subscription','$created_date')";
